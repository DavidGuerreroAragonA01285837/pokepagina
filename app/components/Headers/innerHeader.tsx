...
export default function inner_header(){
    ...
    return (
        ...
        <header className="header">
            ...
            <Link href="/drivers" className="tab_element">Driver Page</Link>
            <Link href="/motor-makers" className="tab_element">Motor Makers</Link>
            <Link href="/pokemon" className="tab_element">Pokemon</Link>
